...
// 查询个人信息
export const reqGetUserProfile = () => request('/system/user/profile');

// 修改个人信息
export const reqUpdateUserProfile = (params: UpdateUserProfileParams) =>
  request('/system/user/profile', { method: 'PUT', data: params });

// 修改密码
export const reqUpdateUserPassword = (params: UpdateUserPasswordParams) =>
  request('/system/user/profile/updatePwd', { method: 'PUT', params });
